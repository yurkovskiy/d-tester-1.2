...
<table align="center" width="500" cellpadding="1" cellspacing="0" class="wcolor">
<tr><td align="center" colspan="2" class="wcolor"><b><i><?php echo $lang['system_version']?></i></b></td></tr>
<tr>
<td rowspan="6" width="20%" align="center" valign="middle">&nbsp;<!--<img align="middle" src="./images/logo.jpg">--></td>
</tr>
<tr><td class="wcolor"><?php echo $lang['login_name']?></td></tr>
<tr><td class="wcolor"><input class="textinputb1" type="text" id="adm_name" name="adm_name" style="width: 100%"></td></tr>
<tr><td class="wcolor"><?php echo $lang['login_pass']?></td></tr>
<tr><td class="wcolor"><input class="textinputb1" type="password" id="adm_pass" name="adm_pass" style="width: 100%"></td></tr>
<tr><td class="wcolor" align="center"><input type="submit" class="button" value="<?php echo $lang['login_submit']?>"></td></tr>
</table>
</form>
