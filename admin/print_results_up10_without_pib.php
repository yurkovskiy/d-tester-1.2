 ...
 * 
 * Last update: 10/05/2012 09:57 GMT +02:00
 * 
 */
...
<!-- Row 4 -->
<tr>
<td class="pro_header_row_title" width="16%"><?php echo $lang['pro_std_year']?></td>
...
<td class="pro_header_row_value" width="9%">&nbsp;</td>
...
<td width="60%" class="pro_header_row_value">&nbsp;</td>
<td width="40%" class="pro_header_row_title"><?php echo "{$lang['pro_date']}&nbsp;&nbsp;<u>&nbsp;{$cur_date}&nbsp;</u>"?></td>
</tr>
</table>
<!-- /Row 3 -->
...
<div class="pro_footer_row" style="font-size: 18px; padding-left: 20px;"><?php echo "{$lang['pro_decan_name']}_______________________"?></div>
