...
if($DB->get_num_rows() != 0)
{
    while($td_row = $DB->fetch_row($test_details))
    {
        ...
        while($q_row = $DB->fetch_row($question))
        {
            ...
            echo "<tr><td width=\"100%\" align=\"left\" colspan=\"2\">&nbsp;</td></tr>\n<tr>\n";
            ...
            echo "</tr>\n";
            $ans_query = $DB->query("SELECT * FROM answers WHERE aq_id='$q_row[0]' AND ans_true = 2 ORDER BY ans_id");
            $ans_counter = 1;
            while($ans_row = $DB->fetch_row($ans_query)) {
                ...
                //printf($lang['ans_favorite'],$ans_counter);
                echo "&nbsp;</td>\n</tr>\n";
                echo "<tr>\n";
                if($ans_row[2] != "0") {
